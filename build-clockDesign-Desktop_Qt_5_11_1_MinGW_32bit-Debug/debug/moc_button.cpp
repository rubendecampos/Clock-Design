...
#include "../../clockDesign/Button/button.h"
...
QT_MOC_LITERAL(3, 14, 13) // "buttonClicked"

    },
    "Button\0close\0\0buttonClicked"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::close)) {
                *result = 0;
                return;
            }
        }
